class Pizza {
    ...
    preparar(){
        console.log(`Preparando una pizza de ${this.tamano} con masa de ${this.masa} y los siguientes ingredientes: ${this.ingredientes}.`);
        return this;
    }   
...
const pizzaPepperoniYJamon = new Pizza("doble", "grande", ["jamón", "queso", "pepperoni"]);

console.log(pizzaPepperoniYJamon.preparar().hornear().empacar());
...
const comboFamiliar = new Combos("Familiar", 4, "grande", "delgada", ["jamón", "champiñon", "queso",], "refreso", "helado");
